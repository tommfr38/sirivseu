...
const POLICY_TERMS = [
  ...
  /\beuropean commission\b/i,
  /\bbrussels\b/i,
  /\bregulat/i, // regulator, regulation, regulatory
  /\bantitrust\b/i,
  /\bgatekeeper\b/i,
...
const PRODUCT_TERMS = [
  ...
  /\blaunch/i,
  /\bdelay/i,
  /\bavailab/i, // available, availability, unavailable
  /\brelease/i,
  /\bfeature/i,
  /\bredesign/i,
  /\brevamp/i,
...
// Tag each article with topics so the UI can filter without re-deriving keywords.
